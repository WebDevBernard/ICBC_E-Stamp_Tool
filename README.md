...
Download the required files from the latest release (v1.0.2):

- 📄 **Config File**  
  [config.xlsx](https://github.com/WebDevBernard/ICBC_E-Stamp_Tool/releases/download/v1.0.2/config.xlsx)

- 🏷 **ICBC E-Stamp and Copy Tool**  
  [icbc_e-stamp_and_copy_tool.exe](https://github.com/WebDevBernard/ICBC_E-Stamp_Tool/releases/download/v1.0.2/icbc_e-stamp_and_copy_tool.exe)
