...
_CHINESE_SURNAMES = frozenset({
    ...
    "zheng", "liang", "xie", "tang", "han", "cao", "deng", "feng", "xiao",
    "peng", "zeng", "cai", "pan", "yuan", "lu", "jiang", "cheng", "dong", "yu",
    "qian", "wei", "tian", "ding", "fu", "shen", "ren", "yao", "meng",
    "yan", "shao", "gu", "shi", "mao", "qin", "bai", "wen", "fan", "fang",
    "kong", "jin", "dai", "tao", "xia", "hao", "hou", "lai", "yin", "xiong",
    "su", "ye", "du", "lei", "cui", "yi", "zhong", "mo", "ruan",
    "long", "ling", "sheng", "kang", "xing", "jia", "qu", "chai",
    # ── Cantonese (Hong Kong romanisation) ────────────────────────
    "chan", "wong", "lee", "cheung", "lau", "ng", "chow", "yip", "kwok",
    "leung", "ho", "yuen", "to", "kwong", "tam", "tsang", "lam", "hui", "mak",
    "choi", "yung", "tse", "kwan", "fong", "hung", "koo", "siu", "poon", "tong",
    "chung", "ting", "woo", "yeung", "lo", "shum", "szeto", "seto", "hau", "mok",
    "sin", "chu", "sze", "ngan", "pak", "wai", "kam", "hom", "gam",
    "chiu", "chau", "fung", "dung", "kung", "lung", "sung", "hong",
    ...
    "ooi", "kooi", "khoo", "low", "teoh", "teo",
    "sim", "seah", "siah", "quah", "quek",
    "chua", "chia", "chee",
...
def _format_insured_name(
    ...
    *,
    ...
    if (has_bcdl_number or not has_bcdl_string) and len(parts) >= 4:
        ...
        compound_last = (
            not is_chinese and len(second) > 2 and second not in _SURNAME_PARTICLES
        )
        if compound_last:
            last = " ".join(parts[:2])
